...
% For the data-driven simulation vertex correction part, since we didn't apply the vertex correction in the most central centralities say 0-20\%, 
...
% Note, to be a short summary, since this vertex correction part really arise a lot of question. The vertex correction factor from most central 0-10\% to most peripheral 70-80\% all the centralities were applied. The same for this general 5\% uncertainties source. 
%Note, Just for plotting, this $\sim$5\% uncertainties was included and shown with "vertex correction" in the Fig.~\ref{sysErr_0_10} and Fig.~\ref{sysErr_10_20}, as you can see, this is not actual vertex correction for 0-10\% and 10-20\%. Again, this 5\% was not applied to the other centralities (say 20-80\%).
...
\url{https://drupal.star.bnl.gov/STAR/system/files/20181029_UIC_GXie.pdf}
