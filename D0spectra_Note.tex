...
\figcaption{comparison of simulated position resolution (DCA XY) vs. p for kaon (black), pion (red) and data measurements (blue).}
...
\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=0.5\textwidth,angle=270]{fig/effPass1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=0.5\textwidth,angle=270]{fig/effPass4.pdf}
\figcaption{Signal efficiency, lowest background efficiency, significance and so on vs. signal efficiency.}
\label{fig:effPass4}
\end{figure}
