...
\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=0.38\textwidth,angle=0]{fig/D0Bump_without_topo.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=0.38\textwidth,angle=0]{fig/D0Bump_with_topo.pdf}
